...
def overview():
    ...
    for student in student_ids:
        ...
        for student_class in student_classes:
            ...
            standard_info = db(student_standards).select(db.standard.id, db.standard.short_name, db.standard.reference_number,db.student_grade.student_score, db.grade.score,orderby=db.standard.short_name)
